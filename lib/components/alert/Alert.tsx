                ...
                <Transition show={show} afterLeave={onClose}>
                    <div
                        className={[
                            ...
                            "ring-1 ring-black ring-opacity-5 transition data-[closed]:data-[enter]:translate-y-2",
                        ...
                        <div className="p-4">
                            <div className="flex items-start">
                                ...
                                <div className="ml-3 flex-1 pt-0.5 min-w-0">
                                    <p className="text-sm font-medium text-gray-900 break-words">{alert.text}</p>
                                </div>
